...
public class AuthConfig : IAuthConfig
{
    ...
    {
        get => audience;
        private init => audience = value ?? throw new ArgumentNullException(nameof(Audience), "Missing audience parameter");
    }
    public int TokenLifespanMinutes { get; private init; }
