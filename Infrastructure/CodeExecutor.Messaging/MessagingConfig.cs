...
public class MessagingConfig : IMessagingConfig
{
    ...
    public string Username
    {
        get => username;
        private init =>
            username = value ?? throw new ArgumentNullException(nameof(Username), "Missing username parameter");
    }
    ...
    public string Password
    {
        get => password;
        private init =>
            password = value ?? throw new ArgumentNullException(nameof(Password), "Missing password parameter");
    }
