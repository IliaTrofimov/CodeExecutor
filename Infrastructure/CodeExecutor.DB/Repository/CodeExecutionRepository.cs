                                       ...
                                       ICodeExecutionsEditorRepository
{
    ...
    public async Task<bool> CheckSecretKeyAsync(Guid guid, string validationTag,
    ...
    public async Task<CodeExecution> Create(long userId, long languageId, string sourceCode,
                                            CancellationToken cancellationToken = default)
    {
        ...
        EntityEntry<CodeExecution> execution = dbSet.Add(new CodeExecution
        {
